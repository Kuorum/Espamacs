...
import espamacs.Province
import espamacs.Role
import espamacs.event.*
import espamacs.type.baselineConditions.*
import espamacs.type.*
import espamacs.type.diagnosis.*
import espamacs.type.preimplantSituation.*
import espamacs.type.patientData.*
import espamacs.type.initialData.*
import espamacs.type.implantData.*
import espamacs.type.event.*
import espamacs.type.event.arrhythmia.*
import espamacs.type.event.hemolysis.*
import espamacs.type.event.arterialThromboembolism.*
import espamacs.type.event.hemorrhage.*
import espamacs.type.event.infection.*
import espamacs.type.event.peripheralVascularAccessComplications.*
import espamacs.type.event.renalDysfunction.*
import espamacs.type.event.woundDehiscence.*
import espamacs.type.event.venousThromboembolism.*
import espamacs.type.event.rightHeartFailure.*
import espamacs.type.event.myocardialInfarction.*
import espamacs.type.event.neurologicalDysfunction.*
import espamacs.type.event.pericardialEffusion.*
import espamacs.type.event.malfunctionDevice.*
