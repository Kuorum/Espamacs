...
<content tag="mainContent">
    <a href="#create-espamacsUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <    </div>
</body> id="create-espamacsUser" class="content scaffold-create" role="main">
