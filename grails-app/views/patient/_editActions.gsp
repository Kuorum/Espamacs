...
<div class="dropdown">
    ...
    <ul class="dropdown-menu pull-right">
        <li><g:link mapping="patientPersonalHistory" params="[patientId:patient.id]"><g:message code="patient.navigation.baseData.personalHistory"/> </g:link></li>
        <li><g:link mapping="patientBaselineCondition" params="[patientId:patient.id]"><g:message code="patient.navigation.baseData.baselineConditions"/> </g:link></li>
